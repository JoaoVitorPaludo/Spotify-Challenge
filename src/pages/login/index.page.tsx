...
export function LoginPage() {
  function handleAuthPage() {
    ...
    window.location.href = `${import.meta.env.VITE_API_URL}/authorize?client_id=${import.meta.env.VITE_CLIENT_ID}&redirect_uri=http://localhost:5174/callback&response_type=code&scope=user-top-read playlist-modify-public playlist-modify-private`
  }
  return (
    <S.LoginContainer>
